...
session_start(); //this is where the session for the user starts
...
<html lang="en">  <!-- HTML language set to English -->
    <head>
        <title>Campus Events │ Checkout</title>  <!-- The title of the web page / browser tab-->
...
<div class="container mt-5">
    ...
    <?php
    // Check if the 'basket' session is empty or not set
    if (!isset($_SESSION['basket']) || empty($_SESSION['basket'])) {
        // Display a message if the basket is empty
        echo "<p>Your basket is empty.</p>";
    } else {
        // If the basket has items, display a thank you message for the purchase
...
?>
    ...
    <a href="user-events.php" class="btn btn-primary">Back to Events</a>
</div>
<br><br>
