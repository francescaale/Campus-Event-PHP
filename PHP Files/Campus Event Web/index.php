...
<html lang="en">  <!-- HTML language set to English -->
    <head>
        <title>Campus Events │ Home</title>  <!-- The title of the web page / browser tab-->
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">  <!-- First carousel item (active) -->
                ...
                <div class="carousel-caption">  <!-- Caption for the carousel item -->
                    ...
                    <a href="events.php" class="btn btn-dark">Learn More</a>  <!-- Button link to the events page -->
                </div>
            </div>
            <div class="carousel-item">  <!-- Second carousel item -->
                ...
                <div class="carousel-caption">
                    ...
                    <a href="events.php" class="btn btn-dark">Learn More</a>
                </div>
            </div>
